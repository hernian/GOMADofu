...
namespace GOCalendarSync
{
    ...
    {
        private const string EX_PROPERTY_NAME_SYNC_GUID = Constants.NAME_APP + "SyncGUID";
        ...
        public GoogleCalendarProvider(string calendarID)
        {
            ...
            var fileDataStore = new FileDataStore(Constants.REL_PATH_APPDATA);
            var credential = GoogleWebAuthorizationBroker.AuthorizeAsync(
                CLIENT_SECRETS, SCOPES, "user", CancellationToken.None, fileDataStore
                ).Result;
            var initializer = new BaseClientService.Initializer();
            initializer.HttpClientInitializer = credential;
            initializer.ApplicationName = Constants.NAME_APP;
